...
<body>
	<header>
		<h1>엘솔루 API 테스트 자동 번역 (한국어 → 외국어)</h1>
		<div id="layer-fixed">
				...
				<div class="inner-div" id="inner-div">
					...
					<div class="overlay ">
						<img src="/resources/image/microphone-54.png"
							class="btn img-fluid" onclick="startRecording()" /> 
						<input type="button" class="btn btn_reset" id="clean">
						<a href="/englistTokor" class="btn_englishs"><input type="button" class="englishs" id="goEnglish" value="영한번역"></a>
